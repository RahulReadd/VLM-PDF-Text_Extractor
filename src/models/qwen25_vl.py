"""Adapter for Qwen2.5-VL family (3B / 7B / 7B-AWQ).

Requires: pip install git+https://github.com/huggingface/transformers qwen-vl-utils
Uses Qwen2_5_VLForConditionalGeneration + AutoProcessor.
"""
...
class Qwen25VLAdapter(VLMAdapter):
    ...
    def load(self) -> None:
        ...
        elif self.config.model_id.endswith("-AWQ"):
            pass  # AWQ models are pre-quantized, no extra config needed
